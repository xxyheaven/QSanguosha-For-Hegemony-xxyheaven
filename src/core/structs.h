...
public:
    ...
    static const int S_REASON_NATURAL_MOVE = 0x2A;     //  a card move by rule
    static const int S_REASON_REMOVE_FROM_PILE = 0x3A;  //  cards moved out of game go back into discardpile
    static const int S_REASON_JUDGEDONE = 0x4A;         //  judge card move into discardpile
    static const int S_REASON_CHANGE_EQUIP = 0x5A;      //  replace existed equip
