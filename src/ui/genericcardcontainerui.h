...
protected:
    ...
    CardItem *_createCard(const Card *card);
...
protected:
    ...
    virtual void addEquips(QList<CardItem *> &equips, bool dashbord);
    virtual QList<CardItem *> removeEquips(const QList<int> &cardIds, bool dashbord);
