...
return {
	...
	--["designer:zhangchunhua"] = "",
	["guojue"] = "果决",
	[":guojue"] = "①当你明置此武将牌后，你对一名其他角色造成1点伤害。②当其他角色因受到伤害而进入濒死状态时，若来源为你，你可弃置其一张牌。",
	["shangshi"] = "伤逝",
