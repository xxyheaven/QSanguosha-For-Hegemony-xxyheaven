...
return {
	...
	[":shejian"] = "当你成为牌的目标后，若使用者不为你且目标对应的角色数为1且所有角色的体力值均大于0且你有手牌，你可发动此技能▶"..
		"你弃置所有手牌，你选择：1.弃置使用者X张牌（X为你以此法弃置的牌数）；2.对使用者造成1点普通伤害。",
	["decrease"] = "减",
	["increase"] = "加",
	...
	["suzhi"] = "夙智",
	[":suzhi"] = "锁定技，①当你于回合内因执行【杀】或【决斗】的效果而造成伤害时，若使用者为你且X＜3，你令伤害值+1。②当不为【挟天子以令诸侯】的锦囊牌于你的回合内被使用时，若使用者为你且X＜3，你摸一张牌。③当其他角色的牌于你的回合内因弃置而置入弃牌堆后，若X＜3，你获得其一张牌。④若X＜3，你于回合内使用锦囊牌无距离关系的限制。⑤回合结束时，若X＜3，你于你的下个回合开始之前拥有〖反馈〗。（X为你于此回合内发动〖夙智①〗、〖夙智②〗和〖夙智③〗的次数之和）",
	["zhaoxin"] = "昭心",
