...
--	["@mingfa-zongheng"] = "是否让%dest获得技能：明伐（纵横）",
	...
	--["designer:ty_duyu"] = "",
	["ty_duyu"] = "杜预",
	["illustrator:ty_duyu"] = "凡果",
	["jianguo"] = "谏国",
	[":jianguo"] = "出牌阶段限一次，你可以选择一项令一名角色执行：1. 摸一张牌然后弃置X张手牌；2. 弃置一张牌然后摸X张牌。（X为其手牌数的一半，向下取整且至多为5）",
	["qingshi"] = "倾势",
	[":qingshi"] = "当你于回合内使用【杀】或锦囊牌指定其他角色为目标后，若此牌为你本回合使用的第X张牌（X为你的手牌数），你可以对此牌的目标角色之一造成1点伤害。每回合限两次。",
	["#jianguo-choice"] = "谏国：选择一项效果令%dest执行",
	["jianguo:d1tx"] = "摸一张牌然后弃置一半的手牌",
	["jianguo:t1dx"] = "弃置一张牌然后摸手牌数量一半的牌",
	["qingshi-invoke"] = "是否使用“倾势”，选择一名目标角色，对其造成1点伤害",
	...
	["shuliang"] = "输粮",
	[":shuliang"] = "其他角色的结束阶段开始时，若其与你势力相同且你至其的距离≤“粮”数，你可将一张“粮”置入弃牌堆▶其摸两张牌。" ,
	...
	["qizhi"] = "奇制",
	[":qizhi"] = "当你于回合内使用非装备牌时，你可以弃置不为此牌目标的一名角色的一张牌（若其与你势力不同则改为“手牌”），令其摸一张牌。每回合限三次。",
	["jinqu"] = "进趋",
	[":jinqu"] = "结束阶段，你可以摸两张牌，然后将手牌弃置至X张（X为本回合你发动“奇制”的次数）。",
	["qizhi-invoke"] = "是否使用“奇制”，选择不是此次使用的牌的目标的一名角色",

	["#huangquan"] = "忠事三朝",
	--["designer:huangquan"] = "",
	["huangquan"] = "黄权",
	["illustrator:huangquan"] = "匠人绘",
	["quanjian"] = "劝谏",
	[":quanjian"] = "出牌阶段限一次，你可以选择一个“军令”令一名与你势力相同的角色选择是否执行。若其不执行，则其本回合下次受到的伤害+1。",
	["tujue"] = "途绝",
	[":tujue"] = "限定技，当你处于濒死状态时，你可以将所有牌交给一名其他角色，然后你回复X点体力值并摸X张牌（X为你给出的牌数且至多为3）。",
	["tujue-invoke"] = "是否使用“途绝”，将所有的牌交给一名角色",
	...
	["juzhan"] = "拒战",
	[":juzhan"] = "当你成为【杀】的目标后，若你发动过此技能的次数为偶数，你可以与使用者各摸一张牌，然后若其武将牌均明置，你可以暗置其一张武将牌，本回合不能再明置。"..
		"当你使用【杀】指定目标后，若你发动过此技能的次数为奇数，你可以获得其一张牌，然后你本回合不能对其使用牌。",
	["juzhan-invoke"] = "是否使用“拒战”，选择其中一名目标角色",
	...
	["danshou"] = "胆守",
	[":danshou"] = "每轮限一次，一名角色的准备阶段，你可以弃置区域内所有牌，本回合每阶段开始时（准备阶段和结束阶段除外），若你的手牌数小于等于以此法弃置的牌数，"..
		"你摸一张牌或令你本回合以此法摸牌时多摸一张牌，当你一次性以此法摸四张牌后，你可以对其造成1点伤害。",

	["#danshou-choose"] = "胆守：选择摸%arg张牌，或本回合以此法摸牌时多摸一张牌",
	["danshou:draw"] = "立即摸牌",
	["danshou:exdraw"] = "增加摸牌的张数",
	["#danshou-damage"] = "胆守：选择是否对%dest造成1点伤害",
	...
	["biaozhao"] = "表召",
	[":biaozhao"] = "出牌阶段限一次，你可以选择两名势力不同的其他角色，视为对其中一名角色使用一张【知己知彼】，然后将一张牌交给另一名角色，若如此做，你摸一张牌。",
	["yechou"] = "业仇",
	[":yechou"] = "锁定技，你死亡时，视为对杀死你的角色依次使用三张无距离限制的【杀】，其中：第一张不能被响应，第二张无视目标角色的防具，第三张造成的伤害+1。"..
		"若其以此法进入濒死状态，与其势力相同的其他角色不能对其使用【桃】。",
	["@biaozhao-give"] = "表召：选择一张牌交给%dest",

	["#panjinshu"] = "神女",
	["panjinshu"] = "潘谨淑",
	["illustrator:panjinshu"] = "",
	["zhiren"] = "织纴",
	[":zhiren"] = "当你于回合内使用第一张非转化的红色牌时，你可以选择一项：1.观看牌堆顶的X张牌，然后以任意顺序置于牌堆顶或牌堆底（X为此牌字数）；"..
	"2.弃置一名其他女性角色的装备牌。",
	["yaner"] = "燕尔",
	[":yaner"] = "当一名与你势力相同的其他角色于其出牌阶段失去最后的手牌后，你可以与其各摸一张牌。每回合限一次。",
	...
	["designer:maxiumatie"] = "偷糖＆归零",
	["mashu_maxiumatie"] = "马术",
	["xiaoqi"] = "骁骑",
	[":xiaoqi"] = "当你使用【杀】选择目标时，你可以令此【杀】改为【决斗】，若如此做，你可在此决斗中视为至多打出X张【杀】（X为明置的有马术的武将牌数）。",

	["#xianglang"] = "校书翾翻",
	["xianglang"] = "向朗",
	["illustrator:xianglang"] = "",
	["kanji"] = "勘集",
	...
	["wuyan"] = "无言",
	[":wuyan"] = "魏势力技。锁定技，当你造成渠道为锦囊牌的伤害时，你防止此伤害。锁定技，当你受到渠道为锦囊牌的伤害时，你防止此伤害。",
	["jianyan"] = "建言",
	[":jianyan"] = "蜀势力技。出牌阶段限一次，你可选择一种类别/颜色▶若牌堆里：有此类别/颜色的牌，{系统亮出牌堆里的第一张为此类别/颜色的牌。你令一名男性角色获得此牌}；没有此类别/颜色的牌且弃牌堆里有此类别/颜色的牌，洗牌，{系统亮出牌堆里的第一张为此类别/颜色的牌。你令一名男性角色获得此牌}。",
	["jujian"] = "举荐",
	[":jujian"] = "结束阶段开始时，你可弃置一张不为基本牌的牌并选择一名与你势力相同的其他角色▶你令其变更，若变更后的武将牌含有锁定技，你与其各摸两张牌。",
	["@jianyan-choice"] = "建言：选择你要检索的卡牌种类（颜色或者类别）",
	["@jianyan-give"] = "建言：请选择一名男性角色，将展示的卡牌【%arg %arg2】交给该角色",
	["#JianyanChoice"] = "%from 选择了 %arg",
	["#JianyanFail"] = "牌堆和弃牌堆中均没有 %arg ，结算终止",
	...
	["shilu"] = "嗜戮",
	[":shilu"] = "①当一名角色死亡后，你可将其所有武将牌置于你的武将牌上（均称为“戮”）▶若其是你杀死的，你随机将武将牌里的两张武将牌置于你的武将牌上（均称为“戮”）。"..
