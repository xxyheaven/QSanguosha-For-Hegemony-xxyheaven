...
return {
	...
	["xibing"] = "息兵",
	[":xibing"] = "当{黑色【杀】或黑色普通锦囊牌}于其他角色的出牌阶段内指定目标后，若使用者为该角色且其于此回合内于使用此牌之前未使用过{黑色【杀】或黑色普通锦囊牌}且目标对应的角色数为1，你可发动此技能▶{若其手牌数小于体力值，其将手牌补至X张（X为其体力值），其于此回合内不能使用对应的实体牌均是其手牌区的牌的牌}。若你与其所有武将牌均处于明置状态，你可暗置你的一张不为君主武将牌且不为士兵牌的武将牌▷其暗置你选择的其一张你选择的其一张不为君主武将牌且不为士兵牌的武将牌，你与其于此回合内不能明置以此法暗置的武将牌。",
	...
	[":sidi"] = "①当一名角色受到伤害后，若其与你势力相同且有牌且你：有“驭”且“驭”的类别数＜3，你可发动此技能▶其可将与所有“驭”类别均不同的一张牌置于你的武将牌上（称为“驭”）；"..
			...
			"2.你选择其的一个处于明置状态的武将牌上的技能，此技能于此回合内无效；3.令其选择一名与你势力相同的角色，该角色回复1点体力。" ,
	["drive"] = "驭",
	...
	["guojue"] = "果决",
	[":guojue"] = "①当你第一次明置此武将牌后，若所有角色的体力值均大于0，你对一名其他角色造成1点伤害。②当其他角色因受到伤害而进入濒死状态时，若来源为你，你可弃置其一张牌。",
	["shangshi"] = "伤逝",
	...
	[":kangrui"] = "当牌于一名角色的出牌阶段内指定目标时，若使用者为其且其与你势力相同且此目标对应的角色不为其且目标对应的角色数为1且你于此阶段内未发动过此技能，"..
		"你可取消此目标▶其选择：1.将手牌补至X张（X为其体力上限），除其外的角色于此阶段内不是其使用牌的合法目标；"..
	...
	["huxun"] = "虎勋",
	[":huxun"] = "锁定技，一名角色的回合结束时，若有角色于此回合内因你造成的伤害而进入过濒死状态，"..
		"你选择：1.（你不是体力上限最大的角色）加1点体力上限，回复1点体力；2.可将一名角色装备区或判定区里的一张牌置入另一名角色的相同区域。",
	["yuancong"] = "元从",
	...
	["lixia"] = "礼下",
	[":lixia"] = "其他势力角色的准备阶段开始时，若你不在其攻击范围内，你发动此技能▶其选择：1.令你摸一张牌；2.弃置你装备区里的一张牌▷其失去1点体力。",
	...
	[":quanji"] = "①当你受到伤害后，若你于当前回合内未发动过此技能，你可摸一张牌▶你将一张牌置于武将牌上（称为“权”）。"..
		...
		"③你的手牌上限+X（X为“权”数）。",
	["paiyi"] = "排异",
	[":paiyi"] = "出牌阶段，你可将一张“权”置入弃牌堆并选择一名角色▶其摸两张牌。若其手牌数大于你，你对其造成1点普通伤害。",
	...
	["suzhi"] = "夙智",
	[":suzhi"] = "锁定技，①当你于回合内因执行【杀】或【决斗】的效果而造成伤害时，若使用者为你且X＜3，你令伤害值+1。②当非转化的锦囊牌于你的回合内被使用时，若使用者为你且X＜3，你摸一张牌。③当其他角色的牌于你的回合内因弃置而置入弃牌堆后，若X＜3，你获得其一张牌。④若X＜3，你于回合内使用锦囊牌无距离关系的限制。⑤回合结束时，若X＜3，你于你的下个回合开始之前拥有〖反馈〗。（X为你于此回合内发动〖夙智①〗、〖夙智②〗和〖夙智③〗的次数之和）",
	["zhaoxin"] = "昭心",
