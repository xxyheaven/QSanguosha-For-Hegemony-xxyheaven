...
return {
	...
	["xibing"] = "息兵",
	[":xibing"] = "当{黑色【杀】或黑色普通锦囊牌}于其他角色的出牌阶段内指定目标后，若使用者为该角色且其于此回合内于使用此牌之前未使用过{黑色【杀】或黑色普通锦囊牌}且目标对应的角色数为1，你可发动此技能▶{若其手牌数小于体力值，其将手牌补至X张（X为其体力值），其于此回合内不能使用对应的实体牌均是其手牌区的牌的牌}。若你与其所有武将牌均处于明置状态，你可暗置你的一张不为君主武将牌且不为士兵牌的武将牌▷其暗置你选择的其一张不为君主武将牌且不为士兵牌的武将牌，你与其于此回合内不能明置以此法暗置的武将牌。",
	...
	["chengshang"] = "承赏",
	[":chengshang"] = "当牌于你的出牌阶段内结算完成后，若使用者为你且此牌的目标列表中有对应的角色为其他势力角色的目标且此牌未造成过伤害，你可发动此技能▶你获得牌堆中所有与此牌花色和点数均相同的牌▷此技能于此阶段内无效。",
	...
	["yusui"] = "玉碎",
	[":yusui"] = "当你成为黑色牌的目标后，若使用者与你势力不同且你于当前回合内未发动过此技能，你可失去1点体力▶你选择：1.令其弃置X张手牌（X为其体力上限）；2.令其失去Y点体力（Y=max{其体力值-你的体力值，0}）。",
	["boyan"] = "驳言",
	...
	["deshao"] = "德劭",
	[":deshao"] = "当黑色牌指定目标后，若使用者不为你且其处于明置状态的武将牌数不大于你且此目标对应的角色为你且此牌的目标对应的角色数为1且你于此回合内发动此技能的次数小于你的体力值，你可弃置其一张牌。",
	["mingfa"] = "明伐",
	["#mingfa-effect"] = "明伐",
	[":mingfa"] = "出牌阶段限一次，你可选择一名其他势力角色▶(→)其下个回合结束时，若其手牌数：小于你，你对其造成1点伤害，获得其一张手牌；大于你，你摸X张牌（X=min{你与其手牌数之差,5}）。",

	["mingfazongheng"] = "明伐",
	[":mingfazongheng"] = "出牌阶段限一次，你可弃置一张牌并选择一名其他势力角色▶(→)其下个回合结束时，若其手牌数小于你，{你对其造成1点伤害，获得其一张手牌}。",
	...
	["shenwei"] = "神威",
	[":shenwei"] = "主将技，锁定技，①此武将牌上单独的阴阳鱼个数-1。②摸牌阶段，若你是体力值最大的角色，你令额定摸牌数+2；③若你是体力值最大的角色，你的手牌上限+2。",
	...
	["youyan"] = "诱言",
	[":youyan"] = "当你的牌于你的回合内因弃置而置入弃牌堆后，若你于此回合内未发动过此技能，你可展示牌堆顶的四张牌▶你获得其中与你此次弃置的牌的花色均不相同的所有牌。",
	["zhuihuan"] = "追还",
	["#zhuihuan-damage"] = "追还",
	["#zhuihuan-discard"] = "追还",
	[":zhuihuan"] = "回合结束时，你可{选择：1.选择一名角色▶其获得1枚“追还（伤害）”；2.选择一名角色▶其获得1枚“追还（弃牌）”；"..
		"3.选择两名角色A和B（从你开始按逆时针方向排序）▶A获得1枚“追还（伤害）”，B获得1枚“追还（弃牌）”；"..
		"4.选择两名角色A和B（从你开始按逆时针方向排序）▶A获得1枚“追还（弃牌）”，B获得1枚“追还（伤害）”}"..
		"（“追还”的下标对所有角色均不可见）→当这些角色于你的下个回合开始之前受到伤害后，若其“追还”数大于0，"..
		"你令{{其弃1枚“追还（伤害）”▷其对来源造成1点伤害}。{其弃1枚“追还（弃牌）”▷来源弃置两张手牌}}。",
	...
	[":sidi"] = "①当一名角色受到伤害后，若其与你势力相同且有牌且你：有“驭”且“驭”的类别数＜3，你可发动此技能▶其可将与所有“驭”类别均不同的一张牌置于你的武将牌上（称为“驭”）；"..
			...
			"②其他势力角色的回合开始时，若其存活，你可将至多三张“驭”置入弃牌堆▶你选择等量的项：1.你选择以此法置入弃牌堆的“驭”的类别，其于此回合内不能使用此类别的牌；"..
	...
	["zhaofu"] = "招附",
	[":zhaofu"] = "①出牌阶段开始时，若所有角色的“赏”之和小于3，你可弃置一张牌并选择一名其他角色▶其获得1枚“赏”。"..
	...
	["jingce"] = "精策",
	[":jingce"] = "当不为【挟天子以令诸侯】的牌于出牌阶段内使用结算结束后，若使用者为你且你于此阶段内于使用此牌之前使用过的牌数为X（X为你的体力值-1）"..
		"且所有角色的体力值均大于0，你可令与你势力不同的一名角色执行军令▶若其选择否，你摸两张牌。",
	...
	["jilei"] = "鸡肋",
	[":jilei"] = "当你受到伤害后，若此伤害有来源，你可选择一种牌的类别▶来源于当前回合内不能使用或打出对应的实体牌均是其手牌区里的牌的为此类别的牌，"..
	...
	["kerchief"] = "帻",
	["juedi"] = "绝地",
	[":juedi"] = "锁定技，准备阶段开始时，若你有“帻”，你选择：1.将所有“帻”置入弃牌堆▶你将你的手牌补至X张（X为你的体力上限）；2.{将所有“帻”交给体力值不大于你的一名其他角色▶其回复1点体力，摸Y张牌（Y为你以此法交给该角色的“帻”数）。}。",
	["#yinbingx-compulsory"] = "引兵",
	["juedi:self"] = "弃置帻并摸牌",
	["juedi:give"] = "将帻交给其他角色",
	...
	["mumeng"] = "穆盟",
	[":mumeng"] = "出牌阶段限一次，你可使用对应的实体牌为你的一张红桃手牌的【远交近攻】或【戮力同心】。",
	["naman"] = "纳蛮",
	[":naman"] = "当黑色牌指定目标时，若使用者不为你且目标数大于1，你可判定▶若结果不为♠，你选择：1.令一名角色也成为此牌的目标（无距离关系的限制）；2.取消其中一个目标。",
	["@naman-target"] = "纳蛮：选择为%src使用的【%arg】增加或减少一个目标",

	["#huaxiong"] = "魔将",
	["huaxiong"] = "华雄",
	["illustrator:huaxiong"] = "地狱许",
	["designer:huaxiong"] = "无名",
	["yaowu"] = "耀武",
	[":yaowu"] = "限定技，当你造成伤害后，若此武将牌处于暗置状态，你可发动此技能▶你加2点体力上限，回复2点体力→当你死亡后，与你势力相同的角色各失去1点体力。",
	["shiyong"] = "恃勇",
	[":shiyong"] = "锁定技，当你受到伤害时，若你：未发动过〖耀武〗且是此伤害的渠道的牌不为红色，你摸一张牌；发动过〖耀武〗且是此伤害的渠道的牌不为黑色，来源摸一张牌。",
	...
	["guojue"] = "果决",
	[":guojue"] = "①当你明置此武将牌后，若你未发动过此技能，你对一名其他角色造成1点伤害。②当其他角色因受到伤害而进入濒死状态时，若来源为你，你可弃置其一张牌。",
	["shangshi"] = "伤逝",
	[":shangshi"] = "当你受到伤害后，你可{选择：1.弃置一张牌；2.将X张手牌交给一名角色}▶你摸X张牌。（X为你已损失的体力值）",
	["@guojue-damage"] = "果决：选择一名其他角色对其造成1点伤害",
	["@shangshi-card"] = "是否使用“伤逝”，选择一张牌弃置，或者选择%arg张手牌交给其他角色",
	["@shangshi-card-full"] = "是否使用“伤逝”，选择一张手牌弃置",
	...
	["dingke"] = "定科",
	[":dingke"] = "当一名角色于其回合外并非因使用或打出而失去牌后，若其与你势力相同且你于当前回合内未发动过此技能，你可{选择：1.将一张手牌交给该角色；2.令当前回合角色弃置一张手牌}▶若你的“阴阳鱼”数＜体力上限，你获得1个“阴阳鱼”。",
	["jiyuan"] = "急援",
	[":jiyuan"] = "当一名角色进入濒死状态时，或一名角色得到你因〖定科〗而交给其的牌后，你可令其摸一张牌。",
	...
	["kangrui"] = "亢锐",
	[":kangrui"] = "当牌于一名角色的出牌阶段内指定目标时，若使用者为其且其与你势力相同且此目标对应的角色不为其且目标对应的角色数为1且你于此阶段内未发动过此技能，"..
		"你可取消此目标▶其选择：1.将手牌补至X张（X为其体力值），除其外的角色于此阶段内不是其使用牌的合法目标；"..
		"2.（所有角色的体力值均＞0）此目标对应的角色对使用者使用无对应的实体牌的【决斗】，此【决斗】的伤害值基数+1。",
	...
	["huxun"] = "虎勋",
	[":huxun"] = "一名角色的回合结束时，若有角色于此回合内因你造成的伤害而进入过濒死状态，"..
		"你可选择：1.（你不是体力上限最大的角色）加1点体力上限，回复1点体力；2.可将一名角色装备区或判定区里的一张牌置入另一名角色的相同区域。",
	["yuancong"] = "元从",
	[":yuancong"] = "一名角色的出牌阶段结束时，若其与你势力相同且于此阶段内未造成过伤害，（你令）其可将一张牌交给你▶你可使用一张对应的实体牌为你的一张手牌且与此实体牌牌名相同的牌。",
	...
	["shefu"] = "设伏",
	[":shefu"] = "①出牌阶段限一次，你可将一张手牌扣置于你的武将牌上（称为“伏兵”）。②当对应的实体牌均为其他角色的手牌的牌被使用时，"..
		"若使用者不为你，你可将一张与此牌牌名相同的“伏兵”置入弃牌堆▶你取消此牌的所有目标。③准备阶段开始时，若“伏兵”数大于2，你将X张“伏兵”置入弃牌堆（X=“伏兵”数-2）。",
	["benyu"] = "贲育",
	[":benyu"] = "当你受到伤害后，若X：小于Y，{你可选择：1.将手牌补至min{Y,5}张；2.令来源将手牌弃置至X张}；大于Y，你可弃置(Y+1)张手牌▶对来源造成1点伤害。（X为你的手牌数；Y为来源的手牌数）",
	...
	["lifu"] = "礼辅",
	[":lifu"] = "出牌阶段限一次，你可选择一名角色▶其弃置两张牌，你观看牌堆顶的一张牌并将此牌交给该角色。",
	["yanzhong"] = "言中",
	[":yanzhong"] = "结束阶段开始时，你可选择一个花色并选择一名有手牌的其他角色▶你弃置其一张手牌。若其以此法被弃置的牌：是你选择的花色且花色为红桃，你回复1点体力；是你选择的花色且花色为方块，"..
		"{你摸一张牌，重置武将牌}；是你选择的花色且花色为黑桃，其失去1点体力；是你选择的花色且花色为梅花，其将一张牌交给你；不同，你弃置一张牌。",
	...
	["quanjia"] = "劝驾",
	[":quanjia"] = "副将技，当你明置此武将牌后，若你未发动过此技能▶你发动势力召唤（该角色于以此法进行的明置流程中确定的势力改为其武将牌上标识的势力），"..
		"与你势力相同的角色各摸一张牌，处于明置状态的武将牌上拥有〖仁德〗的角色获得〖章武〗和〖授钺〗。",
	...
	["liangfan"] = "量反",
	[":liangfan"] = "锁定技，准备阶段开始时，若有“函”，你获得“函”▶你失去1点体力→当你于此回合内因执行牌的效果而对一名角色造成伤害后，若此牌对应的实体牌中（曾）有你以此法得到的牌，你可获得其一张牌。",
	["letter"] = "函",
	["#liangfan-effect"] = "量反",
	...
	["midao"] = "米道",
	["#midao-other"] = "米道",
	[":midao"] = "当（曾）有对应的实体牌的{【杀】或伤害类锦囊牌}于一名角色的出牌阶段内指定第一个目标时，若使用者为该角色且其与你势力相同且你于此阶段内未发动过此技能，（你令）其可将一张手牌交给你▶你将其使用的牌改为任意花色和属性。",
	...
	["wenji"] = "问计",
	[":wenji"] = "出牌阶段开始时，你可令一名其他角色将其一张牌交给你（正面朝上移动）▶若其：与你势力不同，你将一张不为你以此法得到的牌以外的牌交给其（正面朝上移动）；与你势力相同或没有势力，你于此回合内使用对应的实体牌中有你以此法得到的牌的牌无距离关系的限制且无次数限制→当牌于此回合内被使用时，若此牌对应的实体牌中（曾）有你以此法得到的牌，你令所有角色不能响应此次使用的牌。",
	["tunjiang"] = "屯江",
	...
	["zhidao"] = "雉盗",
	[":zhidao"] = "锁定技，出牌阶段开始时，你选择一名其他角色▶你至其的距离于此回合内视为1，除其外的的其他角色于此回合内不是你使用牌的合法目标(→)你于此回合出牌阶段内对其造成伤害后，若你于此阶段内于造成此伤害之前未对其造成过伤害，你获得其区域里的一张牌。",
	["jilix"] = "寄篱",
	[":jilix"] = "锁定技，①当红色基本牌或除【联军盛宴】外的红色普通锦囊牌结算结束后，若此牌的最终目标数为1且你是此目标对应的角色，使用者对你使用无对应的实体牌且与此牌牌名相同的牌（无距离关系和目标的限制）。②当你受到伤害时，若你于此阶段内受到过伤害的次数为1，你防止此伤害▶你移除此武将牌。",
	...
	["conquering"] = "克复中原",
	[":conquering"] = "锦囊牌·蜀\n\n使用时机：出牌阶段。\n使用目标：至少一名角色。\n作用效果：目标对应的角色选择：1.使用无对应的实体牌的普【杀】（有距离关系的限制。若其势力为蜀，此【杀】的伤害值基数+1）；2.摸一张牌。",
	...
	["suzhi"] = "夙智",
	[":suzhi"] = "锁定技，①当你于回合内因执行【杀】或【决斗】的效果而造成伤害时，若使用者为你且X＜3，你令伤害值+1。②当非转化的锦囊牌于你的回合内被使用时，若使用者为你且X＜3，你摸一张牌。③当其他角色的牌于你的回合内因弃置而置入弃牌堆后，若X＜3，你获得其一张牌。④若X＜3，你于回合内使用非转化的锦囊牌无距离关系的限制。⑤回合结束时，若X＜3，你于你的下个回合开始之前拥有〖反馈〗。（X为你于此回合内发动〖夙智①〗、〖夙智②〗和〖夙智③〗的次数之和）",
	["zhaoxin"] = "昭心",
	...
	["chenglve"] = "成略",
	[":chenglve"] = "当牌使用结算结束后，若使用者与你势力相同且此牌的目标数大于1，你可令其摸一张牌▶若你受到过渠道为此牌的伤害，你可令一名与你势力相同且两张武将牌均处于明置状态且没有{“先驱”、“珠联璧合”、“阴阳鱼”和“野心家”}的角色获得1枚“阴阳鱼”。",
	["shicai"] = "恃才",
	...
	["congcha"] = "聪察",
	[":congcha"] = "①准备阶段开始时，你可选择一名没有势力的角色▶(→)当其于你的下个回合开始之前第一次明置武将牌后，若其与你：势力相同，你与其各摸两张牌；势力不同，其失去1点体力。②摸牌阶段，若没有没有势力的角色，你可令额定摸牌数+2。",
	["gongqing"] = "公清",
	...
	["jinfa"] = "矜伐",
	[":jinfa"] = "出牌阶段限一次，你可弃置一张牌并选择一名有牌的其他角色▶其选择：1.令你获得其一张牌；2.将一张装备牌交给你，若此牌在你的手牌区里为黑桃，其对你使用无对应的实体牌的普【杀】。",
	...
	["xishe"] = "袭射",
	[":xishe"] = "其他角色的准备阶段开始时，若其存活，你可弃置装备区里的一张牌▶你对其使用无对应的实体牌的普【杀】（无距离关系的限制，若其体力值小于你，所有角色不能响应此【杀】），你可重复此流程→此回合结束前，若你于此回合内因渠道为此【杀】的伤害而杀死过角色，你可变更（以此法作为你的副将的武将牌处于暗置状态）。",
	...
	[":huaiyi"] = "出牌阶段限一次，你可展示所有手牌▶若不为同一颜色，你选择一种颜色，弃置所有为此颜色的手牌，选择至多X名有牌的其他角色，"..
		"获得这些角色的各一张牌（X为你以此法弃置的手牌数），将你以此法得到的牌中的所有装备牌置于你的武将牌上（均称为“异”且你能如手牌般使用或打出“异”）。",
	["zisui"] = "恣睢",
	...
	[":tongling"] = "当你于出牌阶段内对一名角色A造成伤害后，若A存活且与你势力不同且你于此阶段内未发动过此技能，你可选择一名与你势力相同的角色B▶"..
		"B可对包括A在内的角色使用对应的实体牌是B的一张手牌且与此实体牌牌名相同的牌▷若此牌：造成过伤害，你与B各摸两张牌；"..
	...
	["fangyuan"] = "方圆",
	[":fangyuan"] = "阵法技，①你为围攻角色的围攻关系中的围攻角色的手牌上限+1。②你为围攻角色的围攻关系中的被围攻角色的手牌上限-1。③结束阶段开始时，你对为你为被围攻角色的围攻关系中的围攻角色的一名角色使用无对应的实体牌的普【杀】。",
