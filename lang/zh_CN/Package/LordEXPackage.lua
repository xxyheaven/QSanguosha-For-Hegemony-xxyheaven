...
return {
	...
	["mingde"] = "明德",
	[":mingde"] = "当黑色牌指定目标后，若使用者不为你且其处于明置状态的武将牌数不大于你且此目标对应的角色为你且此牌的目标对应的角色数为1，你可弃置其一张牌。",
	["qizhan"] = "期战",
	["#qizhan-effect"] = "期战",
	[":qizhan"] = "出牌阶段限一次，你可选择一名其他势力角色▶你可令其于其下个回合结束之前拥有〖期战（纵横）〗→其下个回合结束时，若其手牌数小于你，{你对其造成1点伤害，获得其一张手牌}。",

	["qizhanzongheng"] = "期战",
	[":qizhanzongheng"] = "出牌阶段限一次，你可弃置一张牌并选择一名其他势力角色▶(→)其下个回合结束时，若其手牌数小于你，{你对其造成1点伤害，获得其一张手牌}。",

	["@qizhan-zongheng"] = "是否让%dest获得技能：期战（纵横）",

	["#QizhanEffect"] = "%from 的 %arg 效果生效",
	...
	["yaowu"] = "耀武",
	[":yaowu"] = "锁定技，①当你第一次明置此武将牌后，你加2点体力上限，回复2点体力。②当你受到伤害时，若渠道为红色【杀】，你令来源选择：1.回复1点体力；2.令你减1点体力上限。",
	["@yaowu-choose"] = "耀武：选择回复1点体力或令%src减1点体力上限",
	["yaowu:recover"] = "回复体力",
	["yaowu:losemaxhp"] = "减体力上限",
	...
	["dingke"] = "定科",
	[":dingke"] = "当一名角色于其回合外并非因使用或打出或〖定科〗而失去牌后，若其与你势力相同，你可{选择：1.将一张手牌交给该角色；2.令当前回合角色弃置一张手牌}▶若你的“阴阳鱼”数＜体力上限，你获得1个“阴阳鱼”。",
	["jiyuan"] = "急援",
	[":jiyuan"] = "当一名角色进入濒死状态时，或一名角色得到你因〖定科〗而交给其的牌后，你可令其摸一张牌。",

	["@dingke-choose"] = "定科：选择将一张手牌交给%dest，或令当前回合角色弃置一张手牌",
	["dingke:discard"] = "令当前回合角色弃牌",
	["dingke:givecard"] = "交出手牌",
	...
	[":huxun"] = "锁定技，一名角色的回合结束时，若有角色于此回合内因你造成的伤害而进入过濒死状态，"..
		"你选择：1.（你不是体力上限最大的角色）加1点体力上限；2.可将一名角色装备区或判定区里的一张牌置入另一名角色的相同区域。",
	["yuancong"] = "元从",
	[":yuancong"] = "一名角色的出牌阶段结束时，若其与你势力相同且于此阶段内未造成过伤害，（你令）其可将一张牌交给你▶你可使用一张对应的实体牌为你的一张手牌且与此牌牌名相同的牌。",
	...
	["lixia"] = "礼下",
	[":lixia"] = "一名角色的准备阶段开始时，若其与你势力不同,（你令）其可弃置你装备区里的一张牌▶若你以此法被弃置过牌，其选择：1.弃置两张手牌；2.失去1点体力；3.令你摸两张牌。",

	["@lixia"] = "是否使用%src的“礼下”",
	["@lixia-choose"] = "礼下：请选择执行的操作",
	["lixia_effect:discard"] = "弃置两张手牌",
	...
	["paiyi"] = "排异",
	[":paiyi"] = "出牌阶段限两次，你可将一张“权”置入弃牌堆并选择一名角色▶其摸两张牌。若其手牌数大于你，你对其造成1点普通伤害。",
	...
	["jilix"] = "寄篱",
	[":jilix"] = "副将技，①此武将牌上单独的阴阳鱼个数-1。②当红色基本牌或除【联军盛宴】外的红色普通锦囊牌结算结束后，若此牌的最终目标数为1且你是此目标对应的角色，使用者对你使用无对应的实体牌且与此牌牌名相同的牌（无距离关系和目标的限制）。③当你受到伤害时，若你于此阶段内受到过伤害的次数为1，你防止此伤害▶你移除此武将牌。",
