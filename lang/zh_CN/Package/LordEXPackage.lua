...
return {
	...
	["yanghu"] = "羊祜",
	["designer:yanghu"] = "无名",
	["illustrator:yanghu"] = "甜齿",
	["deshao"] = "德劭",
	[":deshao"] = "当黑色牌指定目标后，若使用者不为你且其处于明置状态的武将牌数不大于你且此目标对应的角色为你且此牌的目标对应的角色数为1且你于此回合发动此技能的次数小于你的体力值，你可弃置其一张牌。",
	["mingfa"] = "明伐",
	["#mingfa-effect"] = "明伐",
	...
	["wuku"] = "武库",
	[":wuku"] = "锁定技，当不为【诏书】的装备牌被使用时，若使用者与你势力不同且“武库”数＜2，你获得1枚“武库”。",
	["miewu"] = "灭吴",
	...
	[":zhaofu"] = "①出牌阶段开始时，若所有角色的“赏”之和小于3，你可弃置一张牌并选择一名其他角色▶其获得1枚“赏”。"..
		"②当基本牌/不为【挟天子以令诸侯】的普通锦囊牌使用结算后，若使用者有“赏”，你可使用无对应的实体牌的与此基本牌/普通锦囊牌牌名相同的牌▶其弃1枚“赏”，系统继续此牌的使用流程。",
	...
	["shangshi"] = "伤逝",
	[":shangshi"] = "当你受到1点伤害后，你可{选择：1.弃置一张牌；2.将X张手牌交给一名角色}▶你摸X张牌。（X为你已损失的体力值）",
	...
	["illustrator:liyan"] = "",
	["jinwu"] = "矜武",
	[":jinwu"] = "出牌阶段开始时，你可选择是否执行军令▶若你选择：是，你使用无对应的实体牌的普【杀】；否，你结束出牌阶段。",
	["zhuke"] = "筑科",
	[":zhuke"] = "主将技，①此武将牌上单独的阴阳鱼个数-1。②你执行的军令改为由你指定。③当你横置或叠置后，你可令一名与你势力相同的角色回复1点体力。",
	["quanjia"] = "劝驾",
	[":quanjia"] = "副将技，当你明置此武将牌后，若你未发动过此技能，你发动势力召唤（以此法明置武将牌的角色不会成为野心家），与你势力相同的角色各摸一张牌，处于明置状态的武将牌上拥有〖仁德〗的角色获得〖章武〗和〖授钺〗。",
	...
	["xishe"] = "袭射",
	[":xishe"] = "其他角色的准备阶段开始时，你可弃置装备区里的一张牌▶你对其使用无对应的实体牌的普【杀】（无距离关系的限制，若其体力值小于你，所有角色不能响应此【杀】），你可重复此流程→此回合结束前，若你于此回合内因渠道为此【杀】的伤害而杀死过角色，你可变更（以此法作为你的副将的武将牌处于暗置状态）。",
	...
	["tongling"] = "通令",
	[":tongling"] = "当你于出牌阶段内对一名角色A造成伤害后，若A与你势力不同且你于此阶段内未发动过此技能，你可选择一名与你势力相同的角色B▶"..
		"B可对包括A在内的角色使用对应的实体牌是B的一张手牌且与此实体牌牌名相同的牌▷若此牌：造成过伤害，你与A各摸两张牌；"..
		"未造成过伤害，A获得是你此次造成的伤害的渠道的牌对应的所有实体牌。",
	["jinyu"] = "近谀",
	[":jinyu"] = "当你明置此武将牌后，你选择所有你至其距离＜2的角色▶这些角色各{若其：所有武将牌均处于明置状态，"..
		"其暗置一张不为君主武将牌且不为士兵牌的武将牌；有不处于明置状态的武将牌，其弃置两张牌}。",
	
	
	["@tongling-invoke"] = "是否使用“通令”，选择一名角色，令其对%dest使用一张牌",
	["@tongling-usecard"] = "通令：选择对%dest使用的牌",
	["@jinyu-hide"] = "近谀：选择暗置自己的一张武将牌",
	["jinyu_hide:head"] = "暗置主将",
	["jinyu_hide:deputy"] = "暗置副将",
