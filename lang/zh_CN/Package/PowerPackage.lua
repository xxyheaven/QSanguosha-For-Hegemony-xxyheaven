...
return {
	...
	["zhengbi"] = "征辟",
	[":zhengbi"] = "出牌阶段开始时，你可选择：1.选择一名没有势力的角色，你于此回合内对其使用牌距离关系的限制且对包括其在内的角色使用牌无次数限制；2.将一张基本牌交给一名有势力的角色▶若其有牌且牌数：为1，其将所有牌交给你；大于1，其将一张不是基本牌的牌或两张基本牌交给你。",
	["@zhengbi"] = "你可以发动“征辟”",
	...
	["zhuwei"] = "筑围",
	[":zhuwei"] = "当你进行的判定结果确定后，若判定牌为【杀】或【决斗】，你可获得此牌▶你可令当前回合角色使用【杀】的次数上限于此回合内+1且其手牌上限于此回合内+1。",
	["@keshou"] = "你可以发动“恪守”，请选择两张颜色相同的牌",
