...
return {
	...
	["jianglve"] = "将略",
	[":jianglve"] = "限定技，出牌阶段，你可选择军令▶你发动势力召唤。你选择所有与你势力相同的其他角色，这些角色各选择是否执行此军令。你加1点体力上限，回复1点体力。所有选择是的角色各{加1点体力上限，回复1点体力}。你摸X张牌（X为以此法回复过体力的角色数）。",
	...
	["keshou"] = "恪守",
	[":keshou"] = "当你受到伤害时，若：没有与你势力相同的其他角色，{你可选择：1.弃置两张颜色相同的手牌▶伤害值-1。若没有与你势力相同的其他角色，你判定，若结果为红色，你摸一张牌；2.判定▶若结果为红色，你摸一张牌}；有与你势力相同的其他角色，{你可弃置两张颜色相同的手牌▶伤害值-1。若没有与你势力相同的其他角色，你判定，若结果为红色，你摸一张牌}。",

	["zhuwei"] = "筑围",
	[":zhuwei"] = "当你进行的判定结果确定后，你可获得此牌▶你可令当前回合角色使用【杀】的次数上限于此回合内+1且其手牌上限于此回合内+1。",
	["@keshou"] = "是否弃置两张颜色相同的手牌发动“恪守”",
	["keshou:judge"] = "是否发动“恪守”，进行判定",
