...
return {
	...
	["zhengbi"] = "征辟",
	[":zhengbi"] = "出牌阶段开始时，你可选择：1.选择一名没有势力的角色，其于此回合结束或明置武将牌之前视为与你势力相同；2.将一张基本牌交给一名有势力的角色▶若其有手牌且手牌数：为1，其将所有手牌交给你；大于1，其将一张不是基本牌的牌或两张基本牌交给你。",
	["@zhengbi"] = "你可以发动“征辟”",
	["@zhengbi-give"] = "征辟：请选择交给%src的两张基本牌，或一张非基本牌",
	["fengying"] = "奉迎",
	[":fengying"] = "限定技，出牌阶段，你可使用对应的实体牌为你的所有手牌的【挟天子以令诸侯】→当此牌被使用时，你选择所有大势力角色。这些角色各将手牌补至X张（X为其体力上限）。",
	["#fengying-after"] = "奉迎（大势力摸牌）",
	...
	["jianglve"] = "将略",
	[":jianglve"] = "限定技，出牌阶段，你可选择军令▶你发动势力召唤。你选择所有与你势力相同的其他角色，这些角色各选择是否执行此军令。你加1点体力上限，回复1点体力。所有选择是的角色各先加1点体力上限再回复1点体力。你摸X张牌（X为以此法回复体力的角色数）。",
	...
	["xuanhuo"] = "眩惑",
	[":xuanhuo"] = "与你势力相同的其他角色的出牌阶段限一次，其可将一张手牌交给你▶其弃置一张牌▷其选择下列技能中其明置的武将牌上没有的一个：“武圣”、“咆哮”、“龙胆”、“铁骑”、“烈弓”、“狂骨”。其于此回合结束或其明置有以此法选择的技能的武将牌之前拥有其以此法选择的技能。",
	["@xuanhuo-choose"] = "眩惑：请选择要获得的技能",
	["@xuanhuo-discard"] = "眩惑：请弃置一张牌",
	["xuanhuoattach"] = "眩惑",
	["&xuanhuoattach"] = "出牌阶段限一次，你可将一张手牌交给法正▶你弃置一张牌▷你选择下列技能中其明置的武将牌上没有的一个：“武圣”、“咆哮”、“龙胆”、“铁骑”、“烈弓”、“狂骨”。你于此回合结束或其明置有以此法选择的技能的武将牌之前拥有其以此法选择的技能。",
	...
	["keshou"] = "恪守",
	[":keshou"] = "当你受到伤害时，你可弃置两张颜色相同的手牌▶伤害值-1。若没有与你势力相同的其他角色，你判定，若结果为红色，你摸一张牌。",
	["zhuwei"] = "筑围",
	[":zhuwei"] = "当你进行的判定结果确定后，若判定牌为【杀】或【决斗】，你可获得此牌▶若此时在你的回合内，你使用【杀】的次数上限于此回合内+1且你的手牌上限于此回合内+1。",
	["@keshou"] = "你可以发动“恪守”，请选择两张颜色相同的手牌",
	...
	["SixDragons"] = "六龙骖驾",
	[":SixDragons"] = "装备牌·防具\n\n技能：\n" ..
					"1. 锁定技，你至与你势力不同的角色的距离-1。\n" ..
					"2. 锁定技，与你势力不同的角色至你的距离+1。\n" ,
	["horse"] = "坐骑",
