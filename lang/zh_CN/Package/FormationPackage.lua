...
return {
	...
	["yizhi"] = "遗志",
	[":yizhi"] = "副将技，（此武将牌上单独的阴阳鱼个数-1）若你的主将的武将牌：有〖观星〗且处于明置状态，此〖观星〗改为{准备阶段开始时，"..
		"你可将牌堆顶的五张牌扣置入处理区（对你可见）▶你将其中任意数量的牌置于牌堆顶，将其余的牌置于牌堆底。}；没有〖观星〗或处于暗置状态，你拥有〖观星〗。",
	["tianfu"] = "天覆",
	...
	["niaoxiang"] = "鸟翔",
	[":niaoxiang"] = "阵法技，当【杀】指定目标后，若{使用者是你且此目标对应的角色与你相邻且未与任何角色处于同一队列}或{使用者是你为围攻角色的围攻关系中的一名围攻角色且此目标对应的角色是此围攻关系中的被围攻角色}，使用者将此目标对应的角色抵消此【杀】的方式改为依次使用两张【闪】。",
	["NiaoxiangSummon"] = "鸟翔",
	...
	["zhangwu"] = "章武",
	["#zhangwu-draw"] = "章武[摸牌]",
	[":zhangwu"] = "锁定技，①当【飞龙夺凤】移至弃牌堆或其他角色的装备区后，你获得此【飞龙夺凤】。②当你并非因使用【飞龙夺凤】而失去【飞龙夺凤】前，你展示此【飞龙夺凤】，将此【飞龙夺凤】的此次移动的目标区域改为牌堆底。③当你并非因使用【飞龙夺凤】而失去【飞龙夺凤】后，你摸两张牌。",
	["shouyue"] = "授钺",
