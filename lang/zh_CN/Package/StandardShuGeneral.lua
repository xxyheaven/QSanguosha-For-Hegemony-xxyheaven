...
return {
	...
	["@rende-choose"] = "仁德：请选择要使用的基本牌",
	["@rende-slash"] = "仁德：请选择使用【%arg】的目标角色",
	
	["#guanyu"] = "美髯公",
	["guanyu"] = "关羽",
	["wusheng"] = "武圣",
	[":wusheng"] = "你可将一张红色牌当【杀】使用或打出。",

	["#zhangfei"] = "万夫不当",
	["zhangfei"] = "张飞",
	["paoxiao"] = "咆哮",
	[":paoxiao"] = "锁定技，①你使用【杀】无次数限制。②当【杀】于出牌阶段被使用时，若使用者为你且此【杀】为你于此回合内使用的第二张【杀】，你摸一张牌。",
	...
	["kongcheng"] = "空城",
	[":kongcheng"] = "锁定技，①当你成为【杀】或【决斗】的目标时，若你没有手牌，你取消此目标。②当你于回合外因其他角色将牌交给你而得到牌后，若你没有除这些牌外的其他手牌，你将这些牌置于武将牌上（均称为“琴”）→摸牌阶段开始时，你获得所有“琴”。",
	...
	["huangzhong"] = "黄忠",
	["liegong"] = "烈弓",
	[":liegong"] = "当【杀】于出牌阶段内指定目标后，若其手牌数不小于你的体力值或不大于你的攻击范围，且使用者为你，你可令此【杀】于对此目标进行的使用结算中不是其使用【闪】的合法目标。",
	...
	["zaiqi"] = "再起",
	[":zaiqi"] = "摸牌阶段开始时，若你已受伤，你可令额定摸牌数改为0▶你亮出牌堆顶的X张牌（X为你已损失的体力值），回复等同于其中红桃牌数的体力，将这些红桃牌置入弃牌堆，获得其余的牌。",
