...
return {
	...
	["guicai"] = "鬼才",
	[":guicai"] = "当判定结果确定前，你可打出对应的实体牌为你的一张手牌且非转化的牌▶系统将此牌作为判定牌，将原判定牌置入弃牌堆。",
	...
	["xiahoudun"] = "夏侯惇",
	["ganglie"] = "刚烈",
	[":ganglie"] = "当你受到伤害后，你可判定。若结果不为红桃，来源选择：1.弃置两张手牌；2.受到你造成的1点普通伤害。",

	["#zhangliao"] = "前将军",
	["zhangliao"] = "张辽",
	["tuxi"] = "突袭",
	[":tuxi"] = "摸牌阶段开始时，你可令额定摸牌数改为0并选择至多两名有手牌的其他角色.你获得这些角色的各一张手牌。",
	["@tuxi-card"] = "你可以发动“突袭”",
