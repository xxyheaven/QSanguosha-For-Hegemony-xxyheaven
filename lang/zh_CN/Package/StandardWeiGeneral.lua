...
return {
	...
	["xiahoudun"] = "夏侯惇",
	["ganglie"] = "刚烈",
	[":ganglie"] = "当你受到伤害后，你可以判定▶若结果为：红色，你对来源造成1点伤害；黑色，你弃置来源的一张牌。",
	...
	["xuchu"] = "许褚",
	["luoyi"] = "裸衣",
	[":luoyi"] = "摸牌阶段结束时，你可弃置一张牌▶当你于此回合内因执行【杀】或【决斗】的效果而对一名角色造成伤害时，你令伤害值+1。",
	...
	["yiji"] = "遗计",
	[":yiji"] = "当你受到伤害后，你可将牌堆顶的两张牌扣置入处理区（对你可见）▶你将这些牌交给任意角色。",
	["#yiji"] = "遗计",
	["@yiji-give"] = "遗计：请将“遗计”牌任意分配给其他角色，或点取消留给自己",
	...
	["#xiahouyuan"] = "虎步关右",
	["xiahouyuan"] = "夏侯渊",
	["illustrator:xiahouyuan"] = "凡果",
	["shensu"] = "神速",
	[":shensu"] = "①判定阶段开始前，你可跳过此阶段和摸牌阶段并选择是你使用无对应的实体牌的普【杀】的合法目标的一名角色▶你对其使用无对应的实体牌的普【杀】。"..
		"②出牌阶段开始前，你可弃置一张装备牌并选择是你使用无对应的实体牌的普【杀】的合法目标的一名角色▶你对其使用无对应的实体牌的普【杀】，跳过此阶段。"..
		"③弃牌阶段开始前，你可失去1点体力并选择是你使用无对应的实体牌的普【杀】的合法目标的一名角色▶你对其使用无对应的实体牌的普【杀】，跳过此阶段。",
	["@shensu1"] = "你可以跳过判定阶段和摸牌阶段发动“神速”",
	["@shensu2"] = "你可以跳过出牌阶段并弃置一张装备牌发动“神速”",
	["@shensu3"] = "你可以跳过弃牌并失去1点体力发动“神速”",

	["#zhanghe"] = "料敌机先",
	["zhanghe"] = "张郃",
	["illustrator:zhanghe"] = "张帅",
	["qiaobian"] = "巧变",
	[":qiaobian"] = "①判定阶段开始前或弃牌阶段开始前，你可弃置一张手牌▶你跳过此阶段。②摸牌阶段开始前，你可弃置一张手牌▶你跳过此阶段，可选择至多两名有手牌的其他角色，获得这些角色的各一张手牌。③出牌阶段开始前，你可弃置一张手牌▶你跳过此阶段，可将一名角色的判定或装备区里的一张牌置入另一名角色的相同区域。",
	...
	["#dianwei"] = "古之恶来",
	["dianwei"] = "典韦",
	["illustrator:dianwei"] = "凡果",
	["qiangxi"] = "强袭",
	[":qiangxi"] = "出牌阶段限一次，你可选择一名其他角色并选择：{1.失去1点体力；2.弃置一张武器牌}▶你对其造成1点普通伤害。",
	...
	["fangzhu"] = "放逐",
	[":fangzhu"] = "当你受到伤害后，你可选择一名其他角色▶其选择：1.摸X张牌，叠置；2.弃置X张牌▷失去1点体力。（X为你已损失的体力值）",
	["fangzhu-invoke"] = "你可以发动“放逐”，选择一名其他角色",
	["@fangzhu-discard"] = "放逐：选择%arg张牌弃置并失去1点体力，或点“取消”摸%arg张牌并叠置",

	["#yuejin"] = "奋强突固",
	["yuejin"] = "乐进",
	["illustrator:yuejin"] = "巴萨小马",
	["xiaoguo"] = "骁果",
	[":xiaoguo"] = "其他角色的结束阶段开始时，若其存活，你可弃置一张基本牌▶其选择：1.弃置一张装备牌▷你摸一张牌；2.受到你造成的1点普通伤害。",
