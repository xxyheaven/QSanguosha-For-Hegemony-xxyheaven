...
return {
	...
	["guicai"] = "鬼才",
	[":guicai"] = "当判定结果确定前，你可打出对应的实体牌为你的一张牌且非转化的牌▶系统将此牌作为判定牌，将原判定牌置入弃牌堆。",
	...
	["xuchu"] = "许褚",
	["luoyi"] = "裸衣",
	[":luoyi"] = "摸牌阶段，你可令额定摸牌数-1▶当你于此回合内因执行【杀】或【决斗】的效果对一名角色造成的伤害结算开始前，若使用者为你，你令伤害值+1。",
	...
	[":daoshu"] = "出牌阶段限一次，你可以选择一种花色并选择一名有手牌的其他角色▶你获得其一张牌并记录此牌的游戏牌ID，若为此ID的牌："..
		"是你选择的花色，你对其造成1点伤害。此技能于此阶段内的发动次数上限+1；不是你选择的花色且你的手牌区有与此牌的花色花色不同的牌，"..
		"你将一张与此牌花色花色不同的手牌交给其；不是你选择的花色且你的手牌均与此牌花色相同，你展示所有手牌。",
	["@daoshu-give"] = "盗书：选择一张不是%arg花色的手牌交给%dest",
