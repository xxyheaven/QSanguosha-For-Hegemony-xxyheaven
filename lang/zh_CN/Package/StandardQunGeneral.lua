...
return {
	...
	["illustrator:lvbu"] = "凡果",
	["wushuang"] = "无双",
	[":wushuang"] = "锁定技，①当【杀】指定目标后，若使用者是你，你将此目标对应的角色抵消此【杀】的方式改为依次使用两张【闪】。"..
		"②当【决斗】指定目标后，你将此目标对应的角色因执行此【决斗】的效果而响应此【决斗】的方式改为依次打出两张【杀】。"..
		"③当你成为【决斗】的目标后，你将使用者因执行此【决斗】的效果而响应此【决斗】的方式改为依次打出两张【杀】。"..
		"④当非转化的【决斗】选择目标后，若使用者为你，你可令至多两名角色也成为此【决斗】的目标。",
	["@wushuang-slash-1"] = "%src 对你【决斗】，你须连续打出两张【杀】",
	["@wushuang-slash-2"] = "%src 对你【决斗】，你须再打出一张【杀】",
	["@wushuang-add"] = "无双：可以为【决斗】增加至多两个目标",
	...
	["lijian"] = "离间",
	[":lijian"] = "出牌阶段限一次，你可弃置一张牌并选择一名其他男性角色A和一名能对A使用无对应的实体牌的【决斗】的其他男性角色B▶B对A使用无对应的实体牌的【决斗】。",
	["biyue"] = "闭月",
	...
	["@lirang-give"] = "礼让：你可将弃置的牌任意分配给其他角色",
	["#lirang"] = "礼让",
	...
	["shuangren"] = "双刃",
	[":shuangren"] = "出牌阶段开始时，你可与一名角色拼点▶若你：赢，你对与其势力相同的一名角色使用无对应的实体牌的普【杀】；未赢，其他角色于此回合内不是你使用牌的合法目标。",
	["@shuangren"] = "你可以发动“双刃”",
	...
	["#panfeng"] = "联军上将",
	["panfeng"] = "潘凤",
	["illustrator:panfeng"] = "凡果",
	["kuangfu"] = "狂斧",
	[":kuangfu"] = "当【杀】于出牌阶段内指定第一个目标后，若使用者为你，你可获得此【杀】的目标对应的所有角色中的一名的装备区里的一张牌▶(→)当此【杀】使用结算结束后，若此【杀】未造成过伤害，你弃置两张手牌。",
	["kuangfu-invoke"] = "是否使用“狂斧”，选择【杀】的一个目标角色",
	["@kuangfu-discard"] = "狂斧：弃置两张手牌",

	["#zoushi"] = "惑心之魅",
	["zoushi"] = "邹氏",
	["illustrator:zoushi"] = "Tuu.",
	["huoshui"] = "祸水",
	[":huoshui"] = "锁定技，①其他角色于你的回合内不能明置武将牌。②当【杀】于你的回合内被使用时，若使用者为你，你选择所有{有处于暗置状态的武将牌且与你势力不同}的角色▶这些角色不能响应此【杀】。"..
	"③当【万箭齐发】于你的回合内被使用时，若使用者为你，你选择所有{有处于暗置状态的武将牌且与你势力不同}的角色▶这些角色不能因执行此【万箭齐发】的效果而打出【闪】。",
	["qingcheng"] = "倾城",
	...
	["#QingchengSecond"] = "%from 对 %to 发动了“%arg”的效果",
}
