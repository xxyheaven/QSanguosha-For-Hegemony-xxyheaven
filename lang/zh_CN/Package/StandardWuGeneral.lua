...
return {
	...
	["xiaoji"] = "枭姬",
	["xiaojidraw"] = "枭姬",
	[":xiaoji"] = "当你失去装备区里的牌后，你可摸两张牌。",

	["#sunjian"] = "武烈帝",
	["sunjian"] = "孙坚",
	["illustrator:sunjian"] = "LiuHeng",
	["yinghun_sunjian"] = "英魂",
	[":yinghun"] = "准备阶段开始时，若你已受伤，你可选择：1.{令一名其他角色摸X张牌。其弃置一张牌。}；2. {令一名其他角色摸一张牌。其弃置X张牌。}。（X为你已损失的体力值）",
	...
	["tianxiang"] = "天香",
	[":tianxiang"] = "当你受到伤害时，你可弃置一张红桃手牌并选择一名其他角色▶你防止此伤害，选择：1.令来源对其造成1点普通伤害▷其摸X张牌"..
