...
return {
	...
	["hongyan"] = "红颜",
	[":hongyan"] = "锁定技，①你的黑桃牌或你的黑桃判定牌的花色视为红桃。②若你的装备区里有红桃牌，你的手牌上限+1。",
	["tianxiang"] = "天香",
	[":tianxiang"] = "当你受到伤害时，若你于当前回合内发动此技能的次数小于2，你可弃置一张红桃手牌并选择一名其他角色▶你防止此伤害，选择于当前回合内未选择过的项："..
