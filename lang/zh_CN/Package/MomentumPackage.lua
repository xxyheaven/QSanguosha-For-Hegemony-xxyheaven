...
return {
	...
	["hengjiang"] = "横江",
	[":hengjiang"] = "当你受到1点伤害后，若当前回合角色的手牌上限大于0，你可令其手牌上限于此回合内-1→此回合结束前，若其存活且{其未于弃牌阶段内弃置过其牌或跳过弃牌阶段}，你摸X张牌（X为你此回合发动“横江”的次数）。",
	["@hengjiang"] = "横江",
	...
	["#madai"] = "临危受命",
	["madai"] = "马岱",
	["designer:madai"] = "凌天翼（韩旭）",
	["illustrator:madai"] = "Thinking",
	["mashu_madai"] = "马术",
	["qianxi"] = "潜袭",
	[":qianxi"] = "准备阶段开始时，你可摸一张牌▶弃置一张牌。距离为1的一名角色于此回合内使用或打出的牌对应的所有实体牌不能均是其手牌区里的与你以此法弃置的牌颜色相同的牌。",
	["#Qianxi"] = "由于“<font color=\"yellow\"><b>潜袭</b></font>”效果，%from 本回合不能使用或打出 %arg 手牌",
	["@qianxi_red"] = "潜袭（红色）",
	["@qianxi_black"] = "潜袭（黑色）",
	["@qianxi-discard"]= "请弃置一张牌",
	["@qianxi-choose"]= "请选择一名其他角色",
	...
	["#chenwudongxi"] = "壮怀激烈",
	["chenwudongxi"] = "陈武＆董袭",
	["designer:chenwudongxi"] = "淬毒",
	["&chenwudongxi"] = "陈武董袭",
	["illustrator:chenwudongxi"] = "地狱许",
	["duanxie"] = "断绁",
	[":duanxie"] = "出牌阶段限一次，你可选择至多X名不处于连环状态的角色（X=max{你已损失的体力值,1}）▶这些角色横置，你横置。",
	["fenming"] = "奋命",
	[":fenming"] = "结束阶段开始时，若你处于连环状态，你可选择所有处于连环状态的角色▶你弃置这些角色的各一张牌。",

	["#dongzhuo"] = "魔王",
	["dongzhuo"] = "董卓",
	["designer:dongzhuo"] = "KayaK（韩旭）",
	["illustrator:dongzhuo"] = "巴萨小马",
	["hengzheng"] = "横征",
	[":hengzheng"] = "摸牌阶段开始时，若你的体力值为1或你没有手牌，且有区域里有牌的其他角色，你可令额定摸牌数改为0并选择所有其他角色▶你获得这些角色各自区域里的一张牌。",
	["baoling"] = "暴凌",
	[":baoling"] = "主将技，限定技，锁定技，出牌阶段结束时，若此武将牌处于明置状态且你有副将，你移除副将的武将牌，加3点体力上限，回复3点体力，获得〖崩坏〗。",
	["benghuai"] = "崩坏",
	...
	["#zhangren"] = "索命神射",
	["zhangren"] = "张任",
	["designer:zhangren"] = "淬毒",
	["illustrator:zhangren"] = "DH",
	["chuanxin"] = "穿心",
	[":chuanxin"] = "当你于出牌阶段内因执行你使用的【杀】或【决斗】的效果而对一名角色造成伤害时，若其与你势力不同或若你明置后会与其势力不同，且其有副将，你可防止此伤害▶其选择：1.弃置装备区里的所有牌▶其失去1点体力；2.移除副将的武将牌。",
