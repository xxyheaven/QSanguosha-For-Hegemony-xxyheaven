...
return {
	...
	["mashu_madai"] = "马术",
	["qianxi"] = "潜袭",
	[":qianxi"] = "准备阶段开始时，你可摸一张牌，你弃置一张牌，令距离为1的一名角色于此回合内使用或打出的牌对应的所有实体牌不能均是其手牌区里的与此牌颜色相同的牌。",
	["@qianxi-discard"] = "潜袭：选择一张要弃置的牌",
	["@qianxi-choose"] = "潜袭：令一名角色本回合无法使用或打出%arg牌",
	...
	[":huangjinsymbol"] = "①准备阶段开始时，若没有“天兵”，你将牌堆顶的X张牌置于武将牌上（均称为“天兵”）（X为群势力角色数）。" ..
