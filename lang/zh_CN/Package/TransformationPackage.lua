...
return {
	...
	["yigui"] = "役鬼",
	[":yigui"] = "①当你第一次明置此武将牌后，你随机将武将牌堆里的两张牌扣置于武将牌上（称为“魂”）。"..
	"②当你需要使用【闪】/【无懈可击】时，若你未于当前回合内以此法使用过【闪】/【无懈可击】，你可将一张“魂”置入武将牌堆▶你使用无对应的实体牌的【闪】/【无懈可击】。"..
	"③当你需要使用与你于当前回合内以此法使用过的牌的牌名均不同的除【闪】外的基本牌/除【无懈可击】外的普通锦囊牌时，你可将一张“魂”置入武将牌堆▶你对"..
	"不包括有势力且不为野心家且势力与你因执行此技能的消耗而置入武将堆的“魂”代表的武将不同的角色在内的角色使用无对应的实体牌的此基本牌/普通锦囊牌。\n",
	["jihun"] = "汲魂",
	[":jihun"] = "①当你受到伤害后，你可随机将武将牌堆里的一张牌扣置于武将牌上（称为“魂”）。"..
	"②当一名角色的濒死结算结束后，若其与你势力相同且存活，你可随机将武将牌堆里的一张牌扣置于武将牌上（称为“魂”）。",
	...
	["diaodu"] = "调度",
	["#diaodu-draw"] = "调度",
	[":diaodu"] = "①出牌阶段开始时，你可获得与你势力相同的一名角色装备区里的一张牌，然后交给另一名角色。②当一名角色使用装备牌时，若其与你势力相同，其可摸一张牌。",
	["@diaodu"] = "是否发动“调度”，获得一名同势力角色的一张装备牌",
	["@diaodu-give"] = "调度：你可以将手牌中的【%arg】交给一名角色",
