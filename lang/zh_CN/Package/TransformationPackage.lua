...
return {
	...
	["qice"] = "奇策",
	[":qice"] = "出牌阶段限一次，你可使用对应的实体牌为你的所有手牌的额定目标数下限不大于你的手牌数的普通锦囊牌▶你可变更。",
	["zhiyu"] = "智愚",
	...
	["diaodu"] = "调度",
	["#diaodu-draw"] = "调度",
	[":diaodu"] = "①出牌阶段开始时，你可获得与你势力相同的一名角色装备区里的一张牌▶若其：为你，你将此牌交给一名角色；不为你，你可将此牌交给另一名角色。②当装备牌被使用时，若使用者与你势力相同，（你令）其可摸一张牌。",
